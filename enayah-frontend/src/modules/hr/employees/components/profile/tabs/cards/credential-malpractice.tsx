        ...
        <div className='grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 sm:gap-4'>
          ...
          >
            <div className='flex min-w-0 items-center gap-2 sm:gap-3'>
              {/* Section icon */}
              <div className='flex size-9 shrink-0 items-center justify-center rounded-lg bg-indigo-500/10 sm:size-10 sm:rounded-xl'>
                <ShieldCheck
                  aria-hidden='true'
                  className='size-4 text-indigo-600 sm:size-5 dark:text-indigo-400'
                />
              </div>
