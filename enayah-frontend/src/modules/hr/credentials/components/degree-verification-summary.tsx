...
export function DegreeVerificationSummary({
  employeeId,
  degreeId,
  verification,
  onManage,
  ...
  //   try {
  //     const blob = await degreeVerificationService.previewEvidence({
  //       employeeId,
  ...
  async function handleDownloadEvidence(): Promise<void> {
    ...
    try {
      const blob = await degreeVerificationService.downloadEvidence({
        employeeId,
        credentialId: degreeId,
        eventId,
      })
  ...
  return (
    ...
    //         <div className='flex size-8 shrink-0 items-center justify-center rounded-xl bg-emerald-500/15 text-emerald-700 dark:text-emerald-400'>
    ...
    //       <Badge className='shrink-0 rounded-full border border-emerald-500/25 bg-emerald-500/15 text-emerald-700 shadow-none hover:bg-emerald-500/15 dark:text-emerald-400'>
    //         <FileCheck2 className='me-1 size-3.5' />
    //         {t('verified')}
    //       </Badge>
    //     </div>
    ...
    //           label={t('verifiedBy')}
    //           value={verification.verifiedBy?.displayName ?? '—'}
    //         />
    ...
    //             <p className='text-xs font-semibold'>{t('remarks')}</p>
    //           </div>
    ...
    //         <div className='flex size-9 shrink-0 items-center justify-center rounded-xl bg-emerald-500/15 text-emerald-700 dark:text-emerald-400'>
    //           <ShieldCheck className='size-4' />
    //         </div>
    ...
    //       <Badge
    //         variant='outline'
    //         className='shrink-0 rounded-full border-emerald-500/30 bg-emerald-500/10 text-emerald-700 dark:text-emerald-400'
    //       >
    //         <FileCheck2 className='me-1 size-3.5' />
    //         {t('verified')}
    //       </Badge>
    ...
    //     <div className='space-y-3 border-t border-emerald-500/15 p-4'>
    //       <div className='grid gap-3 sm:grid-cols-2'>
    //         <div className='flex min-w-0 items-center gap-3 rounded-lg border bg-background/60 px-3 py-2.5'>
